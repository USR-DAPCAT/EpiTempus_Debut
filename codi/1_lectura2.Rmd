...
Generar_taula_plana(dt_index,cataleg = conductor_codis,parametres = dt_parametres)

Generar_taula_plana(dt_index,cataleg = conductor_codis,parametres = here::here(conductor_codis),sheet="parametres")
