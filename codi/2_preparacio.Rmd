...
#[Age for EpiTempus]
#--------------------------------------------------------------------------------------------------------------#
#vi)**EDAT-->age3.cat-><50,[50-65),[65-75),>=75
#--------------------------------------------------------------------------------------------------------------#
...
#vii) convertim les dates i els Na , en una variable DICOTOMICA (0,1)!
#---------------------------------------------------------------------------------------------------------------#
...
#viii) Neuropatia periferica : diagnostico registrado o el valor de monofilamento
...
#---------------------------------------------------------------------------------------------------------------#
#x)**Index de Massa Corporal->IMC.valor_cat: <15,[15-25),[25-30),>=30
#---------------------------------------------------------------------------------------------------------------#
...
#xi)**Index de Massa Corporal->IMC.valor_cat2: <18.5,[18.5-25),[25-30),>=30
#---------------------------------------------------------------------------------------------------------------#
...
#---------------------------------------------------------------------------------------------------------------#
#xii)**Index de Massa Corporal->IMC.valor_cat2: <=35,>35
#---------------------------------------------------------------------------------------------------------------#
...
#---------------------------------------------------------------------------------------------------------------#
#xiia)**Index de Massa Corporal->IMC.valor_cat2: <25,[25-29.9),[30-34.9),[35-35.9],>=40
#---------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(IMC.valor_cat4=case_when( IMC.valor   <25~ 1,
                                                      IMC.valor   >=25 & IMC.valor   <30 ~ 2,  
                                                      IMC.valor   >=30 & IMC.valor   <35 ~ 3,
                                                      IMC.valor   >=35 & IMC.valor   <40 ~ 4,
                                                      IMC.valor   >=40  ~ 5))
...
#---------------------------------------------------------------------------------------------------------------#
#xvii)**FILTRADO GLOMERULAR :CKDEPI.valor  
#---------------------------------------------------------------------------------------------------------------#
...
dt_plana<-dt_plana%>%mutate(CKDEPI.valor_CAT6=case_when(CKDEPI.valor     <15~ 1,
...
#---------------------------------------------------------------------------------------------------------------#
#xxiii)**COLESTEROL LDL LDL.COLESTEROL.LDL, (<70, <100, >100, >130) 
#---------------------------------------------------------------------------------------------------------------#
...
#---------------------------------------------------------------------------------------------------------------#
#xxiv)**COLESTEROL LDL LDL.COLESTEROL.LDL, <70 , 70-99, 100-129 y >o=130
#---------------------------------------------------------------------------------------------------------------#
...
#---------------------------------------------------------------------------------------------------------------#
#xxiva)**COLESTEROL LDL LDL.COLESTEROL.LDL, <55 , 55-70, 70-100 y >=100
#---------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(cLDL.valor_CAT3=case_when(cLDL.valor       <55~ 1,
                                                     cLDL.valor        >=55 & cLDL.valor        <70 ~ 2,
                                                     cLDL.valor        >=70 & cLDL.valor        <100 ~ 3,
                                                     cLDL.valor        >=100  ~ 4))
...
#---------------------------------------------------------------------------------------------------------------#
#**COLESTEROL LDL LDL.COLESTEROL.LDL, <70 , 70-99, 100-129 y >o=130
#---------------------------------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------------------------------#
##xxx)**HBA1C.Cambiar los rangos para HbA1c (<7, [7-10), >=10)
#---------------------------------------------------------------------------------------------------------------#
...
#---------------------------------------------------------------------------------------------------------------#
##xxxi)**HBA1C.Cambiar los rangos para HbA1c (<7, [7-8),[8-) >=10)
#---------------------------------------------------------------------------------------------------------------#
...
#---------------------------------------------------------------------------------------------------------------#
##xxxii)**HBA1C.Cambiar los rangos para HbA1c <6.5 [6.5-7) [7-8), [8-9), [9-10) ,>=10
#---------------------------------------------------------------------------------------------------------------
...
#xxxiia)**HBA1C
#---------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(GLICADA.valor_CAT5=case_when(GLICADA.valor   <7~ 1,
                                                        GLICADA.valor   >=7 & GLICADA.valor   <8 ~ 2,  
                                                        GLICADA.valor   >=8 &   GLICADA.valor   <9 ~ 3,
                                                        GLICADA.valor   >=9 & GLICADA.valor   <10 ~ 4,
                                                        GLICADA.valor   >=10  ~ 5))


#---------------------------------------------------------------------------------------------------------------#
##xxxiii)**TRIGLICERIDOS.TG (<150, >150)
#---------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(TG.valor_CAT=case_when(    TG.valor   >=0 & TG.valor   <=150 ~ 1,  
                                                       TG.valor   >150  ~ 2))
...
#################################
#--------------------------------------------------------------------------------------------------------------#
#insuficiencia renal cronica : Insuficiencia Renal Cronica: #[diagnostico +segun valores de FG, FG<60]
#--------------------------------------------------------------------------------------------------------------#
...
#--------------------------------------------------------------------------------------------------------------#
##xxxviii)* Nefropatia diabe?tica: diagnostico + CAC>300  mg/24h
#--------------------------------------------------------------------------------------------------------------#
dt_plana<-dt_plana%>%mutate(DG.NEFRPDM2=ifelse(DG.NEFRPDM==1 & CAC.valor>300 ,1,0)) 


#--------------------------------------------------------------------------------------------------------------#
##xxxix)*Arteriopatia periferica : diagnostico registrado o el valor de ITB (<0.9)
#--------------------------------------------------------------------------------------------------------------#
...
#convertim  els Na , en una variable DICOTOMICA (0,1)! del DG. (Diagnostics!)
...
#error s'ha de mirar ::20080101!!!

dt_plana<-dt_plana%>%mutate(exclusio1=ifelse(dtindex>=20080101 & dtindex<=20181231,0,1))
